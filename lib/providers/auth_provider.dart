...
class AuthNotifier extends AsyncNotifier<models.User?> {
  ...
  Future<void> _loadUserCountry(String userId) async {
    try {
      ...
      // Date format / Rewards / Learn all read regionProvider, so seed it
      // from the country immediately rather than waiting for the profile
      // fetch to complete a second time.
